...
class TextHeightMeasurer extends React.PureComponent<Props, State> {
  ...
  componentDidMount() {
    // console.log("componentDidMount! textToMeasure:",this.props.textToMeasure);
  ...
  resetInternalState(newTextToMeasure: TextToMeasure[]) {
    ...
    console.log("leftToMeasure.size:", this.leftToMeasure.size);
  ...
  render() {
    console.log("Render");
    console.log("currentlyMeasuring", this.state.currentlyMeasuring);
