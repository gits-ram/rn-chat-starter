...
class RainIcon extends React.Component {
  constructor(props) {
    ...
    this.dropOneStages = [];
    this.dropOneStages.push(
      Animated.timing(this.state.dropOneTimer, {
        toValue: 1,
    ...
    this.dropTwoStages = [];
    this.dropTwoStages.push(
      Animated.timing(this.state.dropTwoTimer, {
        toValue: 1,
    ...
    this.dropThreeStages.push(
      Animated.timing(this.state.dropThreeTimer, {
        toValue: 1,
            ...
            transform: [
              {
                translateY: this.state.dropOneTimer.interpolate({
                  inputRange: [0, 1, 3, 4],
                  outputRange: [
                    -4 / 50 * this.props.size,
                    -3 / 50 * this.props.size,
                    8 / 50 * this.props.size,
                    -4 / 50 * this.props.size,
                  ],
                }),
              },
            ...
            transform: [
              {
                translateY: this.state.dropTwoTimer.interpolate({
                  inputRange: [0, 1, 3, 4],
                  outputRange: [
                    -8.5 / 50 * this.props.size,
                    -7 / 50 * this.props.size,
                    0.5 / 50 * this.props.size,
                    -8.5 / 50 * this.props.size,
                  ],
                }),
              },
