...
import transformUtil from "../../utils/MatrixTransformUtil";
...
class SunIcon extends React.Component {
  constructor(props) {
    ...
    this.growStages.push(
      Animated.timing(this.state.growTimer, {
        toValue: 1,
  ...
  runAnimation() {
    ...
    Animated.parallel([
      ...
      Animated.timing(this.state.rayTimer, {
        toValue: 1,
  ...
  flushRayTransforms(refs, scales) {
    ...
    let matrixes = scales.map(scale =>
      transformUtil.scale(scale.__getValue(), scale.__getValue(), 1),
    );

    transformUtil.transformMutateReturn(matrixes[0], {
      x: -(14.5 / 25.5) * this.state.centreX,
      y: 0,
      z: 0,
    });

    transformUtil.transformMutateReturn(matrixes[1], {
      x: -(10.253 / 25.5) * this.state.centreX,
      y: -(10.253 / 25.5) * this.state.centreY,
      z: 0,
    });

    transformUtil.transformMutateReturn(matrixes[2], {
      x: 0,
      y: -(14.5 / 25.5) * this.state.centreY,
      z: 0,
    });

    transformUtil.transformMutateReturn(matrixes[3], {
      x: 10.253 / 25.5 * this.state.centreX,
      y: -(10.253 / 25.5) * this.state.centreY,
      z: 0,
    });

    transformUtil.transformMutateReturn(matrixes[4], {
      x: 14.5 / 25.5 * this.state.centreX,
      y: 0 * this.state.centreY,
      z: 0,
    });

    transformUtil.transformMutateReturn(matrixes[5], {
      x: 10.253 / 25.5 * this.state.centreX,
      y: 10.253 / 25.5 * this.state.centreY,
      z: 0,
    });

    transformUtil.transformMutateReturn(matrixes[6], {
      x: 0,
      y: 14.5 / 25.5 * this.state.centreY,
      z: 0,
    });

    transformUtil.transformMutateReturn(matrixes[7], {
      x: -(10.253 / 25.5) * this.state.centreX,
      y: 10.253 / 25.5 * this.state.centreY,
      z: 0,
    });
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              ...
              d={
                "M256,144c-61.8,0-112,50.2-112,112s50.2,112,112,112s112-50.2,112-112S317.8,144,\
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M112,256c0-8.8-7.2-16-16-16H64c-8.8,0-16,7.2-16,16s7.2,16,16,16h32C104.8,272,\
							112,264.8,112,256z"
              }
            />
          </Svg>
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M131.5,154.2c6.3,6.2,16.4,6.2,22.6,0c6.3-6.2,6.3-16.4,\
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M256,112c8.8,0,16-7.2,16-16V64c0-8.8-7.2-16-16-16s-16,7.2-16,16v32C240,104.8,\
							247.2,112,256,112z"
              }
            />
          </Svg>
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M380.4,154.2l22.6-22.6c6.2-6.2,6.2-16.4,0-22.6s-16.4-6.2-22.6,0l-22.6,22.6c-6.2,\
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M448,240h-32c-8.8,0-16,7.2-16,16s7.2,16,16,16h32c8.8,0,16-7.2,16-16S456.8,240,\
							448,240z"
              }
            />
          </Svg>
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M380.5,357.8c-6.3-6.2-16.4-6.2-22.6,0c-6.3,6.2-6.3,16.4,0,22.6l22.6,22.6c6.2,6.2,\
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M256,400c-8.8,0-16,7.2-16,16v32c0,8.8,7.2,16,16,16s16-7.2,16-16v-32C272,407.2,\
							264.8,400,256,400z"
              }
            />
          </Svg>
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M131.6,357.8l-22.6,22.6c-6.2,6.2-6.2,16.4,0,22.6s16.4,6.2,22.6,\
