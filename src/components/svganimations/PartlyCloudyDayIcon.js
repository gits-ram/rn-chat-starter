...
class SunCloudIcon extends React.Component {
  ...
  componentDidMount() {
    this.state.rayTimer.addListener(({ value }) => {
      this.flushRayTransforms(
        [this.rayOneRef, this.rayTwoRef, this.rayThreeRef, this.rayFourRef, this.rayFiveRef],
        [
  ...
  flushRayTransforms(refs, scales) {
    ...
    transformUtil.transformMutateReturn(matrixes[0], {
      x: -(19 / 25.5) * this.state.centreX,
      y: -(5 / 25.5) * this.state.centreY,
      z: 0,
    });

    transformUtil.transformMutateReturn(matrixes[1], {
      x: -(15 / 25.5) * this.state.centreX,
      y: -(15 / 25.5) * this.state.centreY,
      z: 0,
    });

    transformUtil.transformMutateReturn(matrixes[2], {
      x: -(5 / 25.5) * this.state.centreX,
      y: -(19.5 / 25.5) * this.state.centreY,
      z: 0,
    });
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M127.8,259.1c3.1-4.3,6.5-8.4,10-12.3c-6-11.2-9.4-24-9.4-37.7c0-44.1,35.7-79.8,\
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M16,224h32c8.8,0,16-7.2,16-16s-7.2-16-16-16H16c-8.8,0-16,7.2-16,16S7.2,224,16,224z"
              }
            />
          </Svg>
        </Animated.View>
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M83.5,106.2c6.3,6.2,16.4,6.2,22.6,0c6.3-6.2,6.3-16.4,0-22.6L83.5,\
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M208,64c8.8,0,16-7.2,16-16V16c0-8.8-7.2-16-16-16s-16,7.2-16,16v32C195,56.8,\
							199.2,64,208,64z"
              }
            />
          </Svg>
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M332.4,106.2l22.6-22.6c6.2-6.2,6.2-16.4,0-22.6c-6.2-6.2-16.4-6.2-22.6,\
        ...
        <Animated.View
          ...
          <Svg viewBox={"0 0 512 512"} height={this.props.size} width={this.props.size}>
            <Path
              fill={this.props.colour}
              d={
                "M352,208c0,8.8,7.2,16,16,16h32c8.8,0,16-7.2,16-16s-7.2-16-16-16h-32C359.2,\
